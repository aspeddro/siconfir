...
#' @param class is a numeric vector, integer between 1 and 4. Class of accounting accounts that receive entries of an equity nature
...
msc_equity <- function(year, 
  ...
  if (!(class %in% 1:4)) {
    stop("Argument class should be 1, 2, 3 or 4")
  }
